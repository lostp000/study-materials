...
### 5. `POST /quality-flags-from-csv` – детальные флаги качества по CSV-файлу

Эндпоинт анализирует CSV-файл и возвращает полный набор булевых флагов качества данных, включая все эвристики :
...
- вызывает функции из `eda_cli.core`:
  ...
  - `missing_table`,
  - `compute_quality_flags`;
- Возвращает только булевы флаги (без общей оценки качества).
